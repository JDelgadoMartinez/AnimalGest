        ...
        <div class="about">
            <div class="container">
                <div class="about-padding-w3ls">
                    ...
                    <?php
                    $conexiondb->get_results_from_query("SELECT * FROM animales WHERE adopcion='0'");
                    ...
                    for ($i = 0; $i < count($animales); $i++) {
                        $animal = $animales[$i];
                    ?>
                        <div s style=" float: left; background-color: #E8F6F3; width: 30%; height: 100%; word-wrap: break-word; margin-left: 20px; margin-bottom: 20px; padding: 10px; box-shadow: 2px 2px 2px 2px; border-radius: 10px; margin-top: 15px;">
                            <div class="col-md-12 about-img">
                                <img src="admin/<?= $animal['imagen']; ?>" style="width: 100%; height: 150px;">
                            </div>
                            <div class="form-group" style="padding: 5px;">
                                <h4 style="color: #2874A6;"><?= $animal["nombreAnimal"]; ?></h4>
                            </div>
                            <div class="about-text-padding-agile">
                                <p style="color: black; width: 100px; text-align: left; font: oblique 120% cursive;"><?= $animal["descripcion"]; ?></p>
                            </div>
                            <div class="about-text-padding-agile">
