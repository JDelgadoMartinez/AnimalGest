...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-10-2024 a las 23:10:09
...
--
ALTER TABLE `trabajadores`
  ADD CONSTRAINT `trabajadores_ibfk_1` FOREIGN KEY (`idTrabajador`) REFERENCES `registrados` (`idRegistrado`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
