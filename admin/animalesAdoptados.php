        ...
        <div class="about">
            <div class="container">
                <div class="about-padding-w3ls">
                    <h3 class="wp-block-heading has-text-align-left is-style-asterisk has-body-font-family has-medium-font-size" style="font-style:normal;font-weight:600">ADOPTADOS</h3>
                    <?php
                    $conexiondb->get_results_from_query("SELECT * FROM animales WHERE adopcion='1' AND acogida='0'");
                    ...
                    for ($i = 0; $i < count($animales); $i++) {
                        $animal = $animales[$i];
                    ?>
                        <form class="form-horizontal" style="height: 100%; margin: 0 auto;" action="gestionAnimales.php" method="post">
